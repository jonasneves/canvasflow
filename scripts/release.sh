...
- AI-powered insights with structured outputs
...
echo -e "  3. Ensure manifest.json is at the root of the new zip"
echo -e ""
echo -e "  See ${BLUE}dist/README.md${NC} for detailed instructions"
